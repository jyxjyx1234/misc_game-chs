本补丁包含 花は折りたし梢は高し 与 嘘と真琴にお仕置きを 两部的合集。请搜索 “恋する乙女のお仕置き授業”。如果购买了单独的DL版，可以找我适配。

本补丁由ALyCE\jyxjyx1234制作，使用Deepseek-R1进行翻译。
...
将补丁中的内容覆盖到游戏目录。从 恋する乙女のお仕置き授業_CHS.exe 启动，无需转区。
