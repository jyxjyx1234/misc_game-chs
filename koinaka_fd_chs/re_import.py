...
ori_file=json.load(open("CODE2.json","r",encoding='utf8'))
...
#不同游戏会有细微不同，需要修改
name_and_message=re.compile(b'(\x78\x53\x00\x00\x00\x79\x01\x7a\x00)([\x00-\xff])([\x00-\xff]*?)(\x42\x7b)|(\x1B\x12\x00\x01\x06\x00\x20\x54\x00\x00\x00\xff\x02\x06\x00\x70\x70\xa8\x00\x00\xFF\xFF)([\x00-\xff]*?)(\x1B\x03\x00\x01\x06\x00\x70\xAD\xAC\x00\x00\xFF\xFF)|(\x78\x70\x00\x00\x00\x79\x01\x7a\x00[\x00-\xff])([\x00-\xff]*?)(\x42\x7b)')#2:name,5:message,8:op
