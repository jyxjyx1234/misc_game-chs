...
a.addname(jp_name=["祐介"],chs_name=["祐介"],sex="",role="",other="",reverse=False)
a.addname(jp_name=["吉田"],chs_name=["吉田"],sex="",role="",other="",reverse=False)
a.addname(jp_name=["高瀬 美由紀"],chs_name=["高濑 美由纪"],sex="woman",role="",other="",reverse=False)
