...
class HanziReplacer(object):
    def __init__(self) -> None:
        ...
        self.enablechars = self.charlist
        self.tempdict={}
        self.hanzidict={}
        self.allchars = []
    ...
    def _Createhanzidict(self):
        for char in self.tempdict:
            try:
                ...
                print(self.charlist + "\n\n", file=f)
                print("".join(list(self.tempdict.keys())), file=f)
        ...
        self.allchars = [self.source_chars] + self.allchars
    ...
    def ChangeFont(self,ori_font,outpath,font_name):
        ...
        scale_factor=1.1
        obj['hhea']["ascender"] = int(obj['hhea']["ascender"] * scale_factor*0.8)
        obj['hhea']["descender"] = int(obj['hhea']["descender"] * scale_factor*1.5)
        obj['hhea']["lineGap"] = int(obj['hhea']["lineGap"] * scale_factor*1.1)
        obj['OS_2']["sTypoAscender"] = int(obj['OS_2']["sTypoAscender"] * scale_factor*0.8)
        obj['OS_2']["sTypoDescender"] = int(obj['OS_2']["sTypoDescender"] * scale_factor*1.4)
        obj['OS_2']["sTypoLineGap"] = int(obj['OS_2']["sTypoLineGap"] * scale_factor*1.1)
        obj['OS_2']["usWinAscent"] = int(obj['OS_2']["usWinAscent"] * scale_factor*0.8)
        obj['OS_2']["usWinDescent"] = int(obj['OS_2']["usWinDescent"] * scale_factor*1.4)
        #for i in obj['OS_2']:
