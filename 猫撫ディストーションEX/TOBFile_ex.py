...
class TOBText():
    ...
    def readText(self):
        ...
        for i in self.datas:
            ...
            unknownPatten = re.compile(rb"\x08\x00\x00\x00\x03\x2C\x00\x20\x00\x00\x00\xF0\xCF\xD0\x01\x38\x92\xCE\x01\x2D\x00\x00\x00\x00\x00\x00\x00[\x00-\xff]\x00\x00\x00\x48\x92\xCE\x01\x1F")
