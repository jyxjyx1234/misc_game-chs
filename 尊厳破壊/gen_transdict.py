...
#additem用于添加非人名的字典
a.addname(jp_name=["深美 真姫"],chs_name=["深美 真姫"],sex="woman",role="",other="",reverse=False)
a.addname(jp_name=["寺田 絵里"],chs_name=["寺田 绘里"],sex="woman",role="",other="",reverse=False)
a.addname(jp_name=["幸島 博人"],chs_name=["幸岛 博人"],sex="man",role="",other="",reverse=False)
