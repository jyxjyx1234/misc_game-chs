...
需要先安装1.02修正补丁！！需要先安装1.02修正补丁！！需要先安装1.02修正补丁！！

补丁地址：http://cappuccino-soft.jp/lacryma-web/soramitsu/support.html

补丁的exe需要转区打开！！补丁的exe需要转区打开！！补丁的exe需要转区打开！！

将补丁中的内容覆盖到游戏目录。必须转区启动。
