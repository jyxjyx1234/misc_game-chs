本补丁由ALyCE\jyxjyx1234制作，由使用Sakura进行翻译。
...
将补丁中的内容覆盖到游戏目录（注意，是Launcher所在的目录，而不是Run文件夹内）。从Launcher_chs.exe启动，无需转区。请勿安装字体。

在免DVD补丁的基础上对Auth.exe进行了其他的处理，免DVD补丁已经集成，所以请勿再次安装免DVD补丁，以免被覆盖。
