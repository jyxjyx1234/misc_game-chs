...
#additem用于添加非人名的字典
a.addname(jp_name=["上屋 環"],chs_name=["上屋 环"],sex="woman",role="",other="",reverse=False)
a.addname(jp_name=["カミヤ タマキ"],chs_name=["上屋 环"],sex="woman",role="",other="",reverse=False)
a.addname(jp_name=["浅羽 託"],chs_name=["浅羽 托"],sex="man",role="",other="",reverse=False)
a.addname(jp_name=["アサバ タクス"],chs_name=["浅羽 托"],sex="man",role="",other="",reverse=False)
