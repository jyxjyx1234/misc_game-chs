...
def replace_halfwidth_with_fullwidth(string):
    ...
    fullwidth_chars = "，？！〜０１２３４５６７８９ｑｗｅｒｔｙｕｉｏｐａｓｄｆｇｈｊｋｌｚｘｃｖｂｎｍＱＷＥＲＴＹＵＩＯＰＡＳＤＦＧＨＪＫＬＺＸＣＶＢＮＭ\u3000＿：（）ー"
...
class OriJsonOutput():
    ...
    def add_text(self, text):
        ...
        self.dic["hangshu"] = self.dic.get("hangshu",0) + 1
    ...
    def append_dict(self, quchong = False, remove_name = True):
        ...
        self.outlist.append(self.dic.copy())
