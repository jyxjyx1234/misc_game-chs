...
#  error This NDIS API version is not supported on the target architecture.
#endif
...
// Force the code to define *some* version.  6.30 is a good choice.
#  error Define version with NDIS### or NDIS###_MINIPORT (see top of NDIS.H)
#endif
...
NdisIMSetInternalBindings(
    _In_      NDIS_HANDLE             DriverHandle,
    _In_      NDIS_HANDLE             NdisBindingHandle,
    _In_      ULONG                   NumberOfInternalBindings,
    _In_opt_  PUNICODE_STRING         DeviceId,
    _In_opt_  PUNICODE_STRING         InstanceIds,
    _In_opt_  PUNICODE_STRING         HardwareIds,
    _In_opt_  PUNICODE_STRING         CompatibleIds
    );
