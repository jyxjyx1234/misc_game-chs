...
typedef _Must_inspect_result_ NTSTATUS (*PTRANSFER_CODEC_VERBS) (_In_ PVOID _context, _In_ ULONG Count, _Inout_updates_(Count) PHDAUDIO_CODEC_TRANSFER CodecTransfer, _In_ PHDAUDIO_TRANSFER_COMPLETE_CALLBACK Callback, _In_ PVOID Context);
typedef _Must_inspect_result_ NTSTATUS (*PALLOCATE_CAPTURE_DMA_ENGINE) (_In_ PVOID _context, _In_ UCHAR CodecAddress, _In_ PHDAUDIO_STREAM_FORMAT StreamFormat, OUT PHANDLE Handle, _Out_ PHDAUDIO_CONVERTER_FORMAT ConverterFormat);
...
typedef _Must_inspect_result_ NTSTATUS (*PALLOCATE_DMA_BUFFER) (_In_ PVOID _context, _In_ HANDLE Handle, _In_ SIZE_T RequestedBufferSize, _Out_ PMDL *BufferMdl, _Out_ PSIZE_T AllocatedBufferSize, OUT PUCHAR StreamId, _Out_ PULONG FifoSize);
...
typedef _Must_inspect_result_ NTSTATUS (*PSET_DMA_ENGINE_STATE) (_In_ PVOID _context, _In_ HDAUDIO_STREAM_STATE StreamState, _In_ ULONG NumberOfHandles, _In_ PHANDLE Handles);
...
typedef _Must_inspect_result_ NTSTATUS (*PREGISTER_EVENT_CALLBACK) (_In_ PVOID _context, _In_ PHDAUDIO_UNSOLICITED_RESPONSE_CALLBACK Routine, _In_ PVOID Context, _Out_ PUCHAR Tag);
typedef _Must_inspect_result_ NTSTATUS (*PUNREGISTER_EVENT_CALLBACK) (_In_ PVOID _context, _In_ UCHAR Tag);
typedef _Must_inspect_result_ NTSTATUS (*PGET_DEVICE_INFORMATION) (_In_ PVOID _context, _In_ _Out_ PHDAUDIO_DEVICE_INFORMATION DeviceInformation);
