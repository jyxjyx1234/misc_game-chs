...
__MACHINEARM(long _InterlockedAdd(_Interlocked_operand_ long volatile * _Addend, long _Value))
__MACHINEARM(__int64 _InterlockedAdd64(_Interlocked_operand_ __int64 volatile * _Addend, __int64 _Value))
...
__MACHINEX64(unsigned char _InterlockedCompareExchange128(_Interlocked_operand_ __int64 volatile * _Destination, __int64 _ExchangeHigh, __int64 _ExchangeLow, __int64 * _ComparandResult))
...
__MACHINE(__int64 __cdecl _InterlockedCompareExchange64(_Interlocked_operand_ __int64 volatile * _Destination, __int64 _Exchange, __int64 _Comparand))
...
__MACHINEARM_X64(void * _InterlockedCompareExchangePointer(_Interlocked_operand_ void * volatile * _Destination, void * _Exchange, void * _Comparand))
...
__MACHINEARM_X64(void * _InterlockedExchangePointer(_Interlocked_operand_ void * volatile * _Target, void * _Value))
...
__MACHINEARM(__int64 _InterlockedXor64_rel(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
...
#else
__MACHINEARM(int _MoveFromCoprocessor(unsigned int, unsigned int, unsigned int, unsigned int, unsigned int))
__MACHINEARM(int _MoveFromCoprocessor2(unsigned int, unsigned int, unsigned int, unsigned int, unsigned int))
#endif
...
__MACHINEARM(__int64 __ldrexd(__int64 volatile *))
...
__MACHINEX86_X64(int __cdecl _inp(unsigned short))
__MACHINEX86_X64(unsigned long __cdecl _inpd(unsigned short))
__MACHINEX86_X64(unsigned short __cdecl _inpw(unsigned short))
...
__MACHINEX86_X64(int __cdecl _outp(unsigned short, int))
__MACHINEX86_X64(unsigned long __cdecl _outpd(unsigned short, unsigned long))
__MACHINEX86_X64(unsigned short __cdecl _outpw(unsigned short, unsigned short))
__MACHINE(_Check_return_ unsigned int __cdecl _rotl(_In_ unsigned int _Value, _In_ int _Shift))
__MACHINE(unsigned short _rotl16(unsigned short _Value, unsigned char _Shift))
__MACHINE(_Check_return_ unsigned __int64 __cdecl _rotl64(_In_ unsigned __int64 _Value, _In_ int _Shift))
__MACHINE(unsigned char _rotl8(unsigned char _Value, unsigned char _Shift))
__MACHINE(_Check_return_ unsigned int __cdecl _rotr(_In_ unsigned int _Value, _In_ int _Shift))
__MACHINE(unsigned short _rotr16(unsigned short _Value, unsigned char _Shift))
__MACHINE(_Check_return_ unsigned __int64 __cdecl _rotr64(_In_ unsigned __int64 _Value, _In_ int _Shift))
...
__MACHINEX86_X64(int __cdecl inp(unsigned short))
__MACHINEX86_X64(unsigned long __cdecl inpd(unsigned short))
__MACHINEX86_X64(unsigned short __cdecl inpw(unsigned short))
__MACHINEX86_X64(int __cdecl outp(unsigned short, int))
__MACHINEX86_X64(unsigned long __cdecl outpd(unsigned short, unsigned long))
__MACHINEX86_X64(unsigned short __cdecl outpw(unsigned short, unsigned short))
