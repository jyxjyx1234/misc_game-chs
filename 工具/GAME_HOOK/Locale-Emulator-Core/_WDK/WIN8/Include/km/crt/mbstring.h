...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbscat_s) unsigned char * __cdecl _mbscat(_Inout_updates_z_(_String_length_(_Curr_) + _String_length_(_Source) + 1) unsigned char *, _In_z_ const unsigned char * _Source);
_CRTIMP_ALT errno_t __cdecl _mbscat_s(_Inout_updates_z_(_SizeInBytes) unsigned char * _Dst, _In_ size_t _SizeInBytes, _In_z_ const unsigned char * _Src);
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_1(errno_t, _mbscat_s, unsigned char, _Dst, _In_z_ const unsigned char *, _DstSizeInBytes)
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbscat, _Inout_updates_z_(_String_length_(_Curr_) + _String_length_(_Source) + 1), unsigned char, _Dest, _In_z_ const unsigned char *, _Source)
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbscpy_s) unsigned char * __cdecl _mbscpy(_Out_writes_z_(_String_length_(_Source) + 1) unsigned char * _Dest, _In_z_ const unsigned char * _Source);
_CRTIMP_ALT errno_t __cdecl _mbscpy_s(_Out_writes_z_(_SizeInBytes) unsigned char * _Dst, _In_ size_t _SizeInBytes, _In_z_ const unsigned char * _Src);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsnbcat_s) unsigned char * __cdecl _mbsnbcat(_Inout_z_ unsigned char *, _In_z_ const unsigned char *, _In_ size_t);
_CRTIMP_ALT errno_t __ALTDECL _mbsnbcat_s(_Inout_updates_z_(_SizeInBytes) unsigned char * _Dst, _In_ size_t _SizeInBytes, _In_z_ const unsigned char * _Src, _In_ size_t _MaxCount);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsnbcpy_s) unsigned char * __cdecl _mbsnbcpy(_Out_writes_(_Count) _Post_maybez_ unsigned char *, _In_z_ const unsigned char *, _In_ size_t);
_CRTIMP_ALT errno_t __ALTDECL _mbsnbcpy_s(_Out_writes_z_(_SizeInBytes) unsigned char * _Dst, _In_ size_t _SizeInBytes, _In_z_ const unsigned char * _Src, _In_ size_t _MaxCount);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsnbset_s) unsigned char * __cdecl _mbsnbset(_Inout_updates_z_(_MaxCount) unsigned char *, _In_ unsigned int, _In_ size_t _MaxCount);
_CRTIMP_ALT errno_t __ALTDECL _mbsnbset_s(_Inout_updates_z_(_SizeInBytes) unsigned char * _Dst, _In_ size_t _SizeInBytes, _In_ unsigned int _Ch, _In_ size_t _MaxCount);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsncat_s) unsigned char * __cdecl _mbsncat(_Inout_z_ unsigned char *, _In_z_ const unsigned char *, _In_ size_t);
_CRTIMP_ALT errno_t __ALTDECL _mbsncat_s(_Inout_updates_z_(_SizeInBytes) unsigned char * _Dst, _In_ size_t _SizeInBytes, _In_z_ const unsigned char * _Src, _In_ size_t _MaxCount);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsncpy_s) unsigned char * __cdecl _mbsncpy(_Pre_notnull_ _Out_writes_(2*_Count) _Post_maybez_ unsigned char *, _In_z_ const unsigned char *, _In_ size_t);
_CRTIMP_ALT errno_t __ALTDECL _mbsncpy_s(_Out_writes_z_(_SizeInBytes) unsigned char * _Dst, _In_ size_t _SizeInBytes, _In_z_ const unsigned char * _Src, _In_ size_t _MaxCount);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsnset_s) unsigned char * __cdecl _mbsnset(_Inout_updates_z_(_MaxCount) unsigned char * _Dst, _In_ unsigned int _Val, _In_ size_t _MaxCount);
_CRTIMP_ALT errno_t __ALTDECL _mbsnset_s(_Inout_updates_z_(_SizeInBytes) unsigned char * _Dst, _In_ size_t _SizeInBytes, _In_ unsigned int _Val, _In_ size_t _MaxCount);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsset_s) unsigned char * __cdecl _mbsset(_Inout_z_ unsigned char * _Str, _In_ unsigned int _Val);
_CRTIMP_ALT errno_t __ALTDECL _mbsset_s(_Inout_updates_z_(_SizeInBytes) unsigned char * _Dst, _In_ size_t _SizeInBytes, _In_ unsigned int _Val);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbstok_s) _Check_return_ unsigned char * __cdecl _mbstok(_Inout_opt_z_ unsigned char * _Str, _In_z_ const unsigned char * _Delim);
_Check_return_ _CRTIMP_ALT unsigned char * __ALTDECL _mbstok_s(_Inout_opt_z_ unsigned char *_Str, _In_z_ const unsigned char * _Delim, _Inout_ _Deref_prepost_opt_z_ unsigned char ** _Context);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbccpy_s) void __cdecl _mbccpy(_Out_writes_bytes_(2) unsigned char * _Dst, _In_z_ const unsigned char * _Src);
...
_CRTIMP_ALT errno_t __ALTDECL _mbccpy_s(_Out_writes_z_(_SizeInBytes) unsigned char * _Dst, _In_ size_t _SizeInBytes, _Out_opt_ int * _PCopied, _In_z_ const unsigned char * _Src);
