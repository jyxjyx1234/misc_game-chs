...
#define VER_PRODUCTBUILD            /* NT */   9200
...
/*--------------------------------------------------------------*/
/* This value is meant to allow segments to target a downlevel  */
/*  operating system, requiring versioning independent of the   */
/*  current OS.                                                 */
/*--------------------------------------------------------------*/
#define VER_PACKAGEBUILD_QFE       16384

/*--------------------------------------------------------------*/
/* this value is used by third party drivers build with the DDK */
/* and internally, to avoid version number conflicts.           */
/*--------------------------------------------------------------*/
#define VER_DDK_PRODUCTVERSION       6,2
#define VER_DDK_PRODUCTVERSION_STR  "6.2"
