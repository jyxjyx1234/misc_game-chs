...
typedef enum _DXGK_MULTIPLANE_OVERLAY_FILTER_TYPE
{
    DXGK_MULTIPLANE_OVERLAY_FILTER_CAPS_BRIGHTNESS         = 0x1,
    DXGK_MULTIPLANE_OVERLAY_FILTER_CAPS_CONTRAST           = 0x2,
    DXGK_MULTIPLANE_OVERLAY_FILTER_CAPS_HUE                = 0x4,
    DXGK_MULTIPLANE_OVERLAY_FILTER_CAPS_SATURATION         = 0x8,
    DXGK_MULTIPLANE_OVERLAY_FILTER_CAPS_STRETCH_QUALITY    = 0x10,
} DXGK_MULTIPLANE_OVERLAY_FILTER_TYPE;
...
typedef _In_ CONST DXGKARGCB_NOTIFY_INTERRUPT_DATA*     IN_CONST_PDXGKARGCB_NOTIFY_INTERRUPT_DATA;
...
typedef struct _DXGK_ALLOCATIONINFOFLAGS
{
    union
    {
        struct
        {
            ...
            UINT    Reserved                : 7;    // 0x001FC000 Following fields are RESERVED and
...
typedef _Inout_ DXGKARG_CREATEALLOCATION2*     INOUT_PDXGKARG_CREATEALLOCATION2;

typedef
    _Check_return_
    _Function_class_DXGK_(DXGKDDI_CREATEALLOCATION2)
    _IRQL_requires_(PASSIVE_LEVEL)
NTSTATUS
APIENTRY
...
typedef _Inout_ DXGKARG_DESCRIBEPAGETABLE *   INOUT_PDXGKARG_DESCRIBEPAGETABLE;

typedef
    _Check_return_
    _Function_class_DXGK_(DXGKDDI_DESCRIBEPAGETABLE)
    _IRQL_requires_(PASSIVE_LEVEL)
NTSTATUS
APIENTRY
...
typedef _Inout_ DXGKARG_UPDATEPAGETABLE *   INOUT_PDXGKARG_UPDATEPAGETABLE;

typedef
    _Check_return_
    _Function_class_DXGK_(DXGKDDI_UPDATEPAGETABLE)
    _IRQL_requires_(PASSIVE_LEVEL)
NTSTATUS
APIENTRY
...
typedef _Inout_ DXGKARG_UPDATEPAGEDIRECTORY *   INOUT_PDXGKARG_UPDATEPAGEDIRECTORY;

typedef
    _Check_return_
    _Function_class_DXGK_(DXGKDDI_UPDATEPAGEDIRECTORY)
    _IRQL_requires_(PASSIVE_LEVEL)
NTSTATUS
APIENTRY
...
typedef _Inout_ DXGKARG_MOVEPAGEDIRECTORY *   INOUT_PDXGKARG_MOVEPAGEDIRECTORY;

typedef
    _Check_return_
    _Function_class_DXGK_(DXGKDDI_MOVEPAGEDIRECTORY)
    _IRQL_requires_(PASSIVE_LEVEL)
NTSTATUS
APIENTRY
...
typedef _Inout_ DXGKARG_SUBMITRENDER*     INOUT_PDXGKARG_SUBMITRENDER;

typedef
    _Check_return_
    _Function_class_DXGK_(DXGKDDI_SUBMITRENDER)
NTSTATUS
APIENTRY
