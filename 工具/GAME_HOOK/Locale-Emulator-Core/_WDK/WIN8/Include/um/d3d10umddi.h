...
#define D3D11DDI_MINOR_HEADER_VERSION 3
#endif
...
typedef struct D3D10DDIARG_CREATEDEVICE
{
    ...
    UINT                            Flags;                  // in:  D3D10DDI_CREATEDEVICE_FLAG_*
#if D3D11DDI_MINOR_HEADER_VERSION >= 3
    PFND3D10DDI_RETRIEVESUBOBJECT * ppfnRetrieveSubObject;  //in/out: pointer to sub-object retrieveal function pointer
#endif
...
// Reserve more bits for D3D11DDI_CREATEDEVICE_FLAG_3DPIPELINESUPPORT_MASK
...
// D3D11DDICAPS_3DPIPELINESUPPORT
    typedef enum D3D11DDI_3DPIPELINELEVEL
    {
        ...
        // Can't use 0x80 or some higher bit(s)
        // because those will clobber other flags
        // Could continue numbering past those
        // flags if needed.
#endif
