...
// D3DDDICAPS_GET_MULTIPLANE_OVERLAY_CAPS
    ...
    typedef struct D3DDDI_MULTIPLANE_OVERLAY_CAPS
    {
        ...
        UINT FilterCaps;         // D3DDDI_MULTIPLANE_OVERLAY_FILTER_TYPE
...
typedef struct _D3DDDI_MULTIPLANE_OVERLAY_ATTRIBUTES
{
    ...
    UINT                                 NumFilters;
    D3DDDI_MULTIPLANE_OVERLAY_FILTER*    pFilters;
...
{
    D3DDDI_SYNCHRONIZATIONOBJECTINFO2       Info;           // in:  Attributes of the synchronization object to create.
    D3DKMT_HANDLE                           hSyncObject;    // out: Handle to the created object.
