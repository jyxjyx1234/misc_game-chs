...
ImageRvaToVa(
    ...
    IN PVOID Base,
    IN ULONG Rva,
    IN OPTIONAL OUT PIMAGE_SECTION_HEADER *LastRvaSection
    );
...
typedef BOOL (CALLBACK *PENUMSOURCEFILETOKENSCALLBACK)(IN PVOID token,  IN size_t size);
...
SymLoadModuleEx(
    ...
    IN DWORD64 BaseOfDll,
    IN DWORD DllSize,
    IN OPTIONAL PMODLOAD_DATA Data,
...
MiniDumpWriteDump(
    ...
    IN OPTIONAL PMINIDUMP_EXCEPTION_INFORMATION ExceptionParam,
    IN OPTIONAL PMINIDUMP_USER_STREAM_INFORMATION UserStreamParam,
    IN OPTIONAL PMINIDUMP_CALLBACK_INFORMATION CallbackParam
    );
