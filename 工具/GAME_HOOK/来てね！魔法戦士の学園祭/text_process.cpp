...
int split_transdata(std::string translated, int hangshu, std::vector<char*>& outVec) {
    ...
    if (hangshu > 3) {
        hangshu = 3;
        MessageBox(0, (L"超出显示范围:" + changeText(translated.c_str())).c_str(), L"Error", 0);
    }
...
void InstallHook_replacetext()
{
    ...
    DWORD oldProtect;
	ScrP = (int*)0x6827bc;
    textBuffer = (char*)0x683020;
    originalFuncAddr = 0x404650;
    ...
    *(DWORD*)(originalFuncAddr + 1) = (DWORD)HookFunction_replacetext - originalFuncAddr - 5;
    ...
    //选项文本
    originalFuncAddr3 = 0x00404f45;
    returnAddress3 = 0x00404f4A;
