...
#みお
熱いものを扱うので[r]
近く通ったりする時は気をつけてくださいね[p]
[_tb_end_text]

[tb_start_text mode=3 ]
#
どうやらみおの服だけではなく、[r]
こちらのシャツなどもやってくれるらしい。[p]
[_tb_end_text]
...
[tb_start_text mode=3 ]
#
アイロンで服を押し伸ばすことは知っていたけど、[r]
洗濯バサミで台に固定するなど、小技があるようだ。[p]
[_tb_end_text]
...
[glink  color="btn_05_black"  storage="" addlog="true" size="20"  x="375"  y="400"  width=""  height=""  text="遠慮します"  _clickable_img=""  target="*s2_1"  ]
[glink  color="btn_05_black"  storage="" addlog="true" size="20"  x="772"  y="400"  width=""  height=""  text="ではちょっとだけ"  _clickable_img=""  target="*s2_2"  ]
[s  ]
