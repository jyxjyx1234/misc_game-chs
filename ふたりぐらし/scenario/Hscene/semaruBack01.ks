...
[macro name="semaruBack01" ]
    ...
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene8_0001.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    わたしのお願いにこたえてくれて[r]
    ありがとうございます[p]
    ...
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene8_0003.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    脱がして、くれますか？[r]
    からだ、とっても熱くて……[p]
    ...
    *semaruBack1
    ...
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene8_0010.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    い、いまのって――……[p]
    [_tb_end_text]
    ...
    *semaruBack2
    ...
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene8_0020.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    あんっ、んんぅっ、そこ、[r]
    そこでもおちんちん、きもちいんですか[p]
    [_tb_end_text]
    ...
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene8_0023.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    ふぁぁぁっ！？[p]
    [_tb_end_text]
    ...
    [if exp="f.virgin.image.id === 0" ]
        ...
        [playse  volume="100"  time="1000"  buf="2"  storage="vo_part/FT_m006_part0018.mp3"  ]
        [tb_start_text mode=3 ]
        #みお
        あげちゃいましたね、わたしのはじめて……[p]
        [_tb_end_text]
