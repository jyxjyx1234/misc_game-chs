[macro name="semaruSeijoui01"]
    ...
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene9_0001.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    先生の、男の人の大きな身体に[r]
    包まれて……[p]
    ...
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene9_0002.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    安心するのに、どきどきもして……[r]
    矛盾するみたいだけど、そうじゃなくて[p]
    [_tb_end_text]
    ...
    [glink_left storage="Hscene/semaruSeijoui01.ks" target="semaruSeijoui01_1" text="きれいだよ"]
    [glink_right storage="Hscene/semaruSeijoui01.ks" target="semaruSeijoui01_2" text="みおをよく見たいから"]
    [s]
    ...
    *semaruSeijoui01_3
    ;スチル切替【03】
    [setSeijouiCG cg="03" time="300"]
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene9_0010.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    手……[p]
    [_tb_end_text]
    ...
    ;スチル切替【03】
    [setSeijouiCG cg="03" time="300"]
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene9_0012.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    やっぱり、先生もそう思います……？[p]
    [_tb_end_text]
    ...
    [glink_center storage="Hscene/semaruSeijoui01.ks" target="semaruSeijoui01_4" text="……本当は前戯とかなんだろうけど"]
    [s]
    ;スチル切替【05】
    *semaruSeijoui01_4
    [setSeijouiCG cg="04" time="300"]
    ...
    ;スチル切替【07】
    [setSeijouiCG cg="07" time="300"]
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene9_0017.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    そんな……“これ”が、[r]
    そうじゃないですか……[p]
    ...
    [glink_center storage="Hscene/semaruSeijoui01.ks" target="semaruSeijoui01_5" text="……みお"]
    [s]
    ...
    *semaruSeijoui01_5
    ...
    [if exp="f.virgin.image.id == 0"]
        ;スチル切替【13】
        [setSeijouiCG cg="13" time="300"]
        [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene9_0025.mp3"  ]
        [tb_start_text mode=3 ]
        #みお
        こんなふうにわたしのはじめてを[r]
        捧げられるなんて、すごくうれしいです[p]
        [_tb_end_text]
        ;処女時の追加台詞
    [endif]
    ;スチル切替【bk100】
    [image layer="2" storage="../bgimage/bk100.jpg" time="300" name="bkcg"]
    [tb_start_text mode=3 ]
    #
    蕩けきっていたみおの秘所から[r]
    さらにふっとちからが抜ける。[p]
    ...
    [fadeinse storage="BGS/piston2fast.mp3" time="6000" loop="true"  ]
    
    [glink_center storage="Hscene/semaruSeijoui01.ks" target="*semaruSeijoui01_6" text="確かに、もうそろそろ……っ"]
    [s]
    *semaruSeijoui01_6
    ;スチル切替【18】
    ...
    ;スチル切替【23】
    [setSeijouiCG cg="23" time="300"]
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene9_0047.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    きもちいい……のはもちろん[r]
    あったんですけど……[p]
    ...
    ;スチル切替【24】
    [setSeijouiCG cg="24" time="300"]
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene9_0048.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    それ以上にしあわせな気分で[r]
    ふわふわしてて……[p]
    ...
    ;スチル切替【25】にしてから、下記どちらか表示
    [setSeijouiCG cg="25" time="300"]

    [if exp="f.virgin.image.id == 0"]
        ;これがみお自認の処女喪失のとき
        [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m008_scene9_0050.mp3"  ]
        [tb_start_text mode=3 ]
        #みお
        はじめてのえっちがこんなに[r]
        すてきで、いいんでしょうか……？[p]
        [_tb_end_text]
        [eval exp="f.virgin = addExperience(f.virgin,'2048','自ら求め、待ちわびたペニスを迎え入れた')" ]
    [else]
        ;それ以外
    ...
    [if exp="!f.flag_replay"]
        ...
        [eval exp="f.semaruEV.HEv.seijoui.total++" ]
        [eval exp="f.semaruEV.HEv.seijoui.today = true" ]
