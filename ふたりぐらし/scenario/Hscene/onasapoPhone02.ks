[macro name="onasapoPhone02" ]
    ...
    [glink addlog="true" color="btn_05_black glink_double_left" addlog="true"  storage=""  size="20"  x="375"  y="400"  width=""  height=""  text="今トイレの個室に入ったばかり"  _clickable_img=""  target="*onasapoPhone02_1"  ]
    [glink addlog="true" color="btn_05_black glink_double_right" addlog="true"  storage=""  size="20"  x="772"  y="400"  width=""  height=""  text="もうズボンをおろしてる"  _clickable_img=""  target="*onasapoPhone02_2"  ]
    [s]
    ...
    *onasapoPhone02_3
    ...
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m009_scene5_0051_r.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    ……おちんちんって、[r]
    血でふくらんでるんですよね[p]
    ...
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m009_scene5_0052_r.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    風船みたいに、根元を強く握ったら[r]
    もっとぶくーってなるんです？[p]
    ...
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m009_scene5_0053_r.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    ほああ……じゃあ、その、調節はどうやって？[r]
    気持ちよさというか[p]
    [_tb_end_text]
    ...
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m009_scene5_0054_r.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    今してる速さがやんわりした感じなんですね[p]
    [_tb_end_text]

    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m009_scene5_0055_r.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    ……？　はい、聞こえてますよ[r]
    衣擦れの音とかで動いてるんだなぁって[p]
    [_tb_end_text]
    ...
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m009_scene5_0059_r.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    速すぎました？[r]
    おちんちんって繊細なんだ……[p]
    ...
    [playse  volume="100"  time="1000"  buf="2"  storage="vo_scene/FT_m009_scene5_0064_r.mp3"  ]
    [tb_start_text mode=3 ]
    #みお
    男の人も濡れるんだ……[r]
    やらしいですね……[p]
    ...
    [glink addlog="true" color="btn_05_black glink_center"  storage=""  size="20"  x="565"  y="400"  width=""  height=""  text="……みお？"  _clickable_img=""  target="*onasapoPhone02_4"  ]
    [s]
    ...
    *onasapoPhone02_4
    ...
    [else]
        ...
        [glink addlog="true" color="btn_05_black glink_center"  storage=""  size="20"  x="565"  y="400"  width=""  height=""  text="あ、ああっ"  _clickable_img=""  target="*onasapoPhone02_5"  ]
        [s]
        ...
        *onasapoPhone02_5
        ...
        [glink addlog="true" color="btn_05_black glink_center"  storage=""  size="20"  x="565"  y="400"  width=""  height=""  text="み――ぉ――ッ！！"  _clickable_img=""  target="*onasapoPhone02_6"  ]
        [s]
