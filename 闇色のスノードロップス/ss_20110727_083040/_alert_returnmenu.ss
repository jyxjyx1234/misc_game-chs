...
excall.front.object[@objno].create_rect(0,0,126,35,  64,64,64,32,  1)

excall.front.object[@objno].child.resize(4)	//四つ作成
...
// 子供オブジェクト、下地、はい、いいえ
excall.front.object[@objno].child[0].create(_alert_base, 1, 0, 0, 1 - @回想中)
excall.front.object[@objno].child[1].create(_alert_btn_yes, 1, 3,17, 0)
excall.front.object[@objno].child[2].create(_alert_btn_no, 1, 42,17, 0)

// ボタンの準備：ボタン番号、グループ番号、動作番号、効果音番号
excall.front.object[@objno].child[1].set_button(0, 9, 1, 0)
excall.front.object[@objno].child[2].set_button(1, 9, 1, 0)
