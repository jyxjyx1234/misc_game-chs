...
_　……在一楼的餐桌旁，我的母亲和一位与她年纪相仿的女性正在交谈。[改ページ]
_　她们似乎是学生时代的朋友，因为要合伙开餐饮店，所以每逢周末都会在我家召开战略会议。
_　[改ページ]
[_tb_end_text]
...
[tb_start_text mode=4 ]
_　……然后这孩子是妮娜，〇〇岁。 是那位朋友的女儿。[改ページ]
_　直到昨天还和母亲待在一起的她，今天却在二楼我的房间里无所事事地发着呆。
_　
_　[改ページ]
[_tb_end_text]
...
[tb_start_text mode=4 ]
[僕]「嘛，倒也无所谓啦……怎么办？看样子还要继续下去呢，这个」[改ページ]
[_tb_end_text]
...
[にぃな]「啊哈，两个人能一起玩的开心事情？接龙游戏之类的？」[改ページ]
[僕]「算了吧～ 那样很快就会结束了吧。一起打游戏怎么样？」[改ページ]
[_tb_end_text]
...
[にぃな]「将～棋？ 妮娜、不知道玩法啊」[改ページ]
[僕]「这样啊。那～我来教你怎么移动棋子吧」[改ページ]
[_tb_end_text]
...
[にぃな]「诶诶！」[改ページ]
[僕]「因、因为实在没事做嘛。而且我们……是年轻的男生和女生啊」[改ページ]
[playse storage="niina011.ogg"]
[にぃな]「但、但是、妮、妮娜还是〇〇生哦？」[改ページ]
[僕]「我、虽然喜欢……〇〇生」[改ページ]
[_tb_end_text]
...
[tb_start_text mode=4 ]
[僕]「不、不愿意的话就算啦。因为妮娜酱是我超喜欢的类型，只是抱着不行就算的心态说的」[改ページ]
[playse storage="niina013.ogg"]
[にぃな]「哼嗯……」[改ページ]
[にぃな]「……」[改ページ]
[playse storage="niina014.ogg"]
[にぃな]「……可以哦」[改ページ]
[僕]「就、就是说啊～说了奇怪的话真的对不起啦。闲得发慌脑子都不正常了」[改ページ]
...
[にぃな]「嘛、稍微一下的话……」[改ページ]
[僕]「你、你是认真的！？没在耍我吧！？」[改ページ]
[playse storage="niina016.ogg"]
[にぃな]「嗯……没在戏弄你啦。妮娜、不会说谎的」[改ページ]
[僕]「太好啦！」[改ページ]
[_tb_end_text]
...
[tb_start_text mode=4 ]
[僕]「哈啊哈啊，能和可爱的〇〇中女生做那种事、还有这种事……」[改ページ]
...
[僕]（呜～嗯……好神奇。我的房间里居然有女孩子）[改ページ]
[elsif exp="f.S1にぃな[0] == 1 || f.S1にぃな[0] == 3 && f.ランダム == 2"]
[eval exp="f.S1にぃな[0] = f.S1にぃな[0] + 1"  cond="f.S1にぃな[0]　< 3"  ]
[僕]（妮娜酱、真的好可爱啊。第一次见到时，心跳得好厉害）[改ページ]
[elsif exp="f.S1にぃな[0] == 2 || f.S1にぃな[0] == 3 && f.ランダム == 3"]
[eval exp="f.S1にぃな[0] = f.S1にぃな[0] + 1"  cond="f.S1にぃな[0]　< 3"  ]
[僕]（不过......这种大胆的放松姿势。简直分不清是谁的房间了）[改ページ]
[endif]
[_tb_end_text]
...
[僕]（妮娜酱最近经常穿这种露肩很多的衣服。那个叫什么来着？）[改ページ]
[elsif exp="f.S1服[0] == 1 || f.S1服[0] == 3 && f.ランダム == 2"]
[eval exp="f.S1服[0] = f.S1服[0] + 1"  cond="f.S1服[0]　< 3"  ]
[僕]（噗噗...胸口那里微微隆起......果然是成长期的感觉）[改ページ]
...
[僕]「......」[改ページ]
[僕]（从刚才开始内裤就完全走光了......是不是该提醒她比较好？）[改ページ]
[僕]（不要，还是算了吧......难得糊涂）」[改ページ]

[elsif exp="f.S1パンツ[0] == 1 || f.S1パンツ[0] == 3 && f.ランダム == 2"]
[eval exp="f.S1パンツ[0] = f.S1パンツ[0] + 1"  cond="f.S1パンツ[0]　< 3"  ]
[僕]（这种毫无防备的地方，果然还是小孩子啊。......虽然让人超开心的）[改ページ]

[elsif exp="f.S1パンツ[0] == 2 || f.S1パンツ[0] == 3 && f.ランダム == 3"]
[eval exp="f.S1パンツ[0] = f.S1パンツ[0] + 1"  cond="f.S1パンツ[0]　< 3"  ]
[僕]（啊～太好了，纯白内裤。心灵都被净化了）[改ページ]
[endif]
[_tb_end_text]
