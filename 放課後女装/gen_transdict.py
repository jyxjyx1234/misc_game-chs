...
a.addname(jp_name=["三崎 蛍"],chs_name=["三崎 萤"],sex="man",role="",other="",reverse=False)
a.addname(jp_name=["佐倉 翼"],chs_name=["佐仓 翼"],sex="man",role="",other="",reverse=False)
a.addname(jp_name=["滝沢 彰人"],chs_name=["泷泽 彰人"],sex="man",role="",other="",reverse=False)
