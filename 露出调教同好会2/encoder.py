...
if __name__ == "__main__":
    codecs.register(custom_codec_search)
    print(b'\x95\x81\x92\x69\x3D\x62\x81\x5B\x83\x8B\x24\x4C\x38\x22\x44\x4E\x53\x02\x92\xBF\x26\x16\x1E\x53\x16\x3A\x8C\x83\x26\x1E\x93\xAE\x97\x68\x28\x55\x97\x9D\x8C\x62\x03'.decode('sb'))