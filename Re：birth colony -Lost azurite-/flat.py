...
def flatten_directory(source_dir):
    ...
    for root, dirs, files in os.walk(source_dir, topdown=False):
        ...
        for file in files:
            ...
            # Move the file
            try:
                # if source_file.endswith(".txt") or source_file.endswith(".csv") or source_file.endswith(".ks") or source_file.endswith(".tjs") or source_file.endswith(".asd") or source_file.endswith(".func"):
