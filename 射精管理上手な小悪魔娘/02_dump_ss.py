...
special_text_code = [38, 2113929298, 2113929299, 2113929296, 2113929301, 76, 65, 2113929303, 2113929275, 2113929274, 2113929276, 83, 2113929293,2113929270,74, 2113929304]
...
for filename in os.listdir(unpacked_ss_path):
    ...
    try:
        ...
        ss.save_str_list(os.path.join("ss_opcodes", filename + ".json"))
