...
a.addname(jp_name=["清白 加奈子"],chs_name=["清白 加奈子"],sex="woman",role="",other="",reverse=False)
a.addname(jp_name=["春日部 陽向"],chs_name=["春日部 阳向"],sex="woman",role="",other="",reverse=False)
a.addname(jp_name=["春日部 美月"],chs_name=["春日部 美月"],sex="woman",role="",other="",reverse=False)
a.addname(jp_name=["砂沢 健二"],chs_name=["砂沢 健二"],sex="man",role="",other="",reverse=False)
a.addname(jp_name=["高遠 明"],chs_name=["高远 明"],sex="man",role="",other="",reverse=False)
a.addname(jp_name=["あきら"],chs_name=["明"],sex="woman",role="",other="",reverse=False)
