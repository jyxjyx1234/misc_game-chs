...
for n in namedict:
    ...
    res.append(orib + b"[=]" + transb + b"[n]")
    if "/" in n:
        orib = n.split("/")[0].encode("932")
        transb = h.hanzitihuan(namedict[n].split("/")[0]).encode("932")
        res.append(orib + b"[=]" + transb + b"[n]")
        orib = n.split("/")[1].encode("932")
        transb = h.hanzitihuan(namedict[n].split("/")[1]).encode("932")
        res.append(orib + b"[=]" + transb + b"[n]")
