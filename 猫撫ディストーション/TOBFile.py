...
class TOBText():
    NamePatten = re.compile(rb"(?<=\x19\x00\x00\x00\x01[\x01-\xff][\x00-\xff]\x00\x00\x02\x01\x01)(?P<namelen>[\x00-\xff][\x00-\xff])(?P<name>[\x01-\xff]*?)(?=\x00)")
...
class TOBFile():
    ...
    def save(self, outPath):
        ...
        jumpPatten2 = re.compile(rb"(?<=\x5B\x20\x00\x00\x00\x00\x02\x26\x01\x00\x00\x00\x00\x00\x00\x0B\x00\x00\x00\x01\x01\x00)([\x00-\xff]{4})")
