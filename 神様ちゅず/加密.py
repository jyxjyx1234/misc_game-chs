...
os.makedirs("release\data", exist_ok=True)

data1 = open_file_b("release\data\TEXT.DAT")
data1_enc = encrypt(data1)
save_file_b("release\data\TEXT.DAT", data1_enc)

data1 = open_file_b("release\data\SCRIPT.SRC")
data1_enc = encrypt(data1)
save_file_b("release\data\SCRIPT.SRC", data1_enc)
