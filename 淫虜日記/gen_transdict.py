...
#additem用于添加非人名的字典
a.addname(jp_name=["浅海 由梨"],chs_name=["浅海 由梨"],sex="woman",role="",other="",reverse=False)
a.addname(jp_name=["大崎 理沙"],chs_name=["大崎 理沙"],sex="woman",role="",other="",reverse=False)
a.addname(jp_name=["良樹"],chs_name=["良树"],sex="man",role="",other="",reverse=False)
