...
class YSTB_command:
    ...
    def type(self) -> str:
        ...
        #    return "sound"
            ...
            return "may_be_opt"
        elif self.opcode == b'\x15\x00\x03\x00' or self.opcode == b'\x16\x00\x03\x00':
            #print(self.opcode)
            return "name_def"
        else:
            return "others"
...
class YSTB_NAMEDEF_FILE(YSTB_FILE):
    ...
    def changenamecharset(self):
        ...
        for command in self.command_list:
            ...
            nameslist.add(content_data[4:-1].decode(encoding='sjis'))
        ...
        save_json("namelist.json", list(nameslist))