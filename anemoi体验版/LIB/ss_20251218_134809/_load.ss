...
// シーンオブジェクトを作成する
//---------------------------------------------------------------------------
command $$create_load_scene_object(property $stage : stage)
{
	$$create_ui_image($stage.object[0], _load_bg, 0, 0)
	$$create_ui_button($stage.object[@ボタン_セーブロード_ＮＥＷページ], _load_page_new_btn, 540, 56, @ボタン_セーブロード_ＮＥＷページ, <OBJBTN_GROUP_NO_EXCALL>, 4)
	$$create_ui_button($stage.object[@ボタン_セーブロード_前のタブ], _load_page_prev_btn, 424, 56, @ボタン_セーブロード_前のタブ, <OBJBTN_GROUP_NO_EXCALL>, 4)
	$$create_ui_button($stage.object[@ボタン_セーブロード_次のタブ], _load_page_next_btn, 482, 56, @ボタン_セーブロード_次のタブ, <OBJBTN_GROUP_NO_EXCALL>, 4)
	$$create_ui_button($stage.object[@ボタン_セーブロード_オートページ], _load_page_auto_btn, 1758, 56, @ボタン_セーブロード_オートページ, <OBJBTN_GROUP_NO_EXCALL>, 4)
	$$create_ui_button($stage.object[@ボタン_セーブロード_クイックページ], _load_page_quick_btn, 1816, 56, @ボタン_セーブロード_クイックページ, <OBJBTN_GROUP_NO_EXCALL>, 4)
	$$create_saveload_thumbnail($stage, $stage.object[@ボタン_セーブロード_サムネイル + 0], _load_thumbnail_btn + math.tostr_zero(1, 2), 61 + 360 * (0 % 5), 142 + 410 * (0 / 5), @ボタン_セーブロード_サムネイル + 0, <OBJBTN_GROUP_NO_EXCALL>, 0)
	$$create_saveload_thumbnail($stage, $stage.object[@ボタン_セーブロード_サムネイル + 1], _load_thumbnail_btn + math.tostr_zero(1, 2), 61 + 360 * (1 % 5), 142 + 410 * (1 / 5), @ボタン_セーブロード_サムネイル + 1, <OBJBTN_GROUP_NO_EXCALL>, 0)
	$$create_saveload_thumbnail($stage, $stage.object[@ボタン_セーブロード_サムネイル + 2], _load_thumbnail_btn + math.tostr_zero(1, 2), 61 + 360 * (2 % 5), 142 + 410 * (2 / 5), @ボタン_セーブロード_サムネイル + 2, <OBJBTN_GROUP_NO_EXCALL>, 0)
	$$create_saveload_thumbnail($stage, $stage.object[@ボタン_セーブロード_サムネイル + 3], _load_thumbnail_btn + math.tostr_zero(1, 2), 61 + 360 * (3 % 5), 142 + 410 * (3 / 5), @ボタン_セーブロード_サムネイル + 3, <OBJBTN_GROUP_NO_EXCALL>, 0)
	$$create_saveload_thumbnail($stage, $stage.object[@ボタン_セーブロード_サムネイル + 4], _load_thumbnail_btn + math.tostr_zero(1, 2), 61 + 360 * (4 % 5), 142 + 410 * (4 / 5), @ボタン_セーブロード_サムネイル + 4, <OBJBTN_GROUP_NO_EXCALL>, 0)
	$$create_saveload_thumbnail($stage, $stage.object[@ボタン_セーブロード_サムネイル + 5], _load_thumbnail_btn + math.tostr_zero(1, 2), 61 + 360 * (5 % 5), 142 + 410 * (5 / 5), @ボタン_セーブロード_サムネイル + 5, <OBJBTN_GROUP_NO_EXCALL>, 0)
	$$create_saveload_thumbnail($stage, $stage.object[@ボタン_セーブロード_サムネイル + 6], _load_thumbnail_btn + math.tostr_zero(1, 2), 61 + 360 * (6 % 5), 142 + 410 * (6 / 5), @ボタン_セーブロード_サムネイル + 6, <OBJBTN_GROUP_NO_EXCALL>, 0)
	$$create_saveload_thumbnail($stage, $stage.object[@ボタン_セーブロード_サムネイル + 7], _load_thumbnail_btn + math.tostr_zero(1, 2), 61 + 360 * (7 % 5), 142 + 410 * (7 / 5), @ボタン_セーブロード_サムネイル + 7, <OBJBTN_GROUP_NO_EXCALL>, 0)
	$$create_saveload_thumbnail($stage, $stage.object[@ボタン_セーブロード_サムネイル + 8], _load_thumbnail_btn + math.tostr_zero(1, 2), 61 + 360 * (8 % 5), 142 + 410 * (8 / 5), @ボタン_セーブロード_サムネイル + 8, <OBJBTN_GROUP_NO_EXCALL>, 0)
	$$create_saveload_thumbnail($stage, $stage.object[@ボタン_セーブロード_サムネイル + 9], _load_thumbnail_btn + math.tostr_zero(1, 2), 61 + 360 * (9 % 5), 142 + 410 * (9 / 5), @ボタン_セーブロード_サムネイル + 9, <OBJBTN_GROUP_NO_EXCALL>, 0)
	$$create_load_all_page_button($stage, _load_page_btn, 601, 56, 58, 0, 20)
}

//---------------------------------------------------------------------------
// サムネイルオブジェクトを作成する
//---------------------------------------------------------------------------
command $$create_load_thumb_object(property $stage : stage, property $obj : object, property $index)
{
	$$create_ui_image($obj.child[@セーブロード_サムネイル_ＮＥＷ], _load_thumbnail_new, 89, 208)
	$$create_ui_number_image($obj.child[@セーブロード_サムネイル_セーブ番号], _load_thumbnail_number, 82, 155)
	$$create_ui_string($obj.child[@セーブロード_サムネイル_日付], 251, 155, 96, 22, 18)
	$$create_ui_string($obj.child[@セーブロード_サムネイル_時間], 355, 156, 46, 21, 18)
	...
	$$create_ui_image($obj.child[@セーブロード_サムネイル_空画像], _load_thumbnail_empty, 89, 203)
	$$create_ui_image($obj.child[@セーブロード_サムネイル_セーブ画像], "", 89, 203)
	$$create_ui_image($obj.child[@セーブロード_サムネイル_ベース], _load_thumbnail_frame, 61, 142)
	$$create_ui_button($stage.object[@ボタン_セーブロード_コメント+$index], _load_thumbnail_comment_btn, 81, 454, @ボタン_セーブロード_コメント+$index, <OBJBTN_GROUP_NO_EXCALL>, 1)
	$$create_ui_toggle_button($stage.object[@ボタン_セーブロード_ロック+$index], _load_thumbnail_lock_btn, 161, 492, @ボタン_セーブロード_ロック+$index, <OBJBTN_GROUP_NO_EXCALL>, 1, 0)
	$$create_ui_button($stage.object[@ボタン_セーブロード_入れ替え+$index], _load_thumbnail_swap_btn, 220, 492, @ボタン_セーブロード_入れ替え+$index, <OBJBTN_GROUP_NO_EXCALL>, 1)
	$$create_ui_button($stage.object[@ボタン_セーブロード_削除+$index], _load_thumbnail_erase_btn, 279, 492, @ボタン_セーブロード_削除+$index, <OBJBTN_GROUP_NO_EXCALL>, 1)
	$$create_ui_string($stage.object[@テキスト_セーブロード_コメント+$index], 126, 463, 247, 20, 17)
}
...
// - 毎フレーム処理を追加することができます
//---------------------------------------------------------------------------
command $$update_load_scene_object(property $stage : stage, property $select_btn)
{
}
...
//---------------------------------------------------------------------------
command $$redraw_load_scene_object(property $stage : stage, property $redraw_type)
{
	property $i
...
//---------------------------------------------------------------------------
command $$show_load_scene_object(property $stage : stage)
{
	property $i
	property $anim_check_obj_no
...
//---------------------------------------------------------------------------
command $$hide_load_scene_object(property $stage : stage)
{
	// ワイプ（表示速度によって変更）
	if( <EFFECT_SPEED_SYS_MENU> )
	{
...
// パッド入力の遷移を設定する
//---------------------------------------------------------------------------
command $$set_load_joypad_navigation(property $stage : stage)
{
	property $i
